...
// Jika sudah memilih, redirect ke selesai.php
if($sudah_memilih){
    header("Location: selesai.php");
    exit();
}

// Halaman ini hanya diakses jika belum memilih, jadi tombol PILIH akan tampil
?>
<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
<title>Detail Kandidat 1</title>
...
<div class="container">
    ...
    <div class="foto"><img src="dicky-hp.png"></div>
    ...
    <div class="content">
        ...
        <div class="name-row">
            <div>
                ...
                <div class="info">
                    <div><span class="label">Nama lengkap</span><p>Dicky Hendry Kurniawan</p></div>
                    <div><span class="label">Tanggal lahir</span><p>1 Januari 2008</p></div>
                    <div><span class="label">Umur</span><p>17 tahun</p></div>
                </div>
                <div class="hobby"><span class="label">Hobi</span><p>Olahraga fisik, latihan baris-berbaris (PBB), membaca literatur kepemimpinan, dan bermain alat musik.</p></div>
            </div>
            <div class="signature">Dicky</div>
        </div>
        <div class="horizontal-line"></div>
        <div class="lower">
            <div class="left-content">
                <p class="paragraph">Dicky Hendry Kurniawan adalah seorang anggota Patroli Keamanan Sekolah (PKS) yang dikenal memiliki dedikasi tinggi terhadap kedisiplinan. Sebagai pribadi yang bertanggung jawab, ia menonjol dalam kepemimpinan lapangan dan selalu mengedepankan etika serta ketertiban dalam bertugas.</p>
                <h2>Latar belakang</h2>
                <p class="paragraph">Tumbuh dalam lingkungan yang menghargai struktur dan aturan, yang kemudian membentuk karakternya menjadi sosok yang taktis dan sigap. Pengalamannya di organisasi PKS telah mengasah kemampuannya dalam manajemen konflik ringan di sekolah serta pengaturan lalu lintas di lingkungan pendidikan.</p>
                <h2>Motivasi</h2>
                <p class="paragraph">Ingin membuktikan bahwa disiplin adalah kunci utama menuju kesuksesan dan ingin memberikan kontribusi nyata bagi kenyamanan belajar di sekolah.</p>
            </div>
            <div class="vertical-line"></div>
            <div class="right-content">
                <h2>Visi & Misi</h2>
                <h3>Visi</h3>
                <p class="paragraph">"Mewujudkan PKS sebagai organisasi yang sigap, tertib, dan menjadi role model (teladan) bagi seluruh siswa dalam hal kedisiplinan dan kepedulian sosial."</p>
                <h3>Misi</h3>
                <p class="paragraph">Meningkatkan Responsivitas: Menjamin setiap anggota PKS selalu siap siaga (sigap) dalam menjaga keamanan lingkungan sekolah.<br><br>Penegakan Ketertiban: Mengimplementasikan aturan sekolah secara tegas namun tetap persuasif dan edukatif.<br><br>Penguatan Karakter: Membentuk anggota yang memiliki integritas tinggi agar layak menjadi contoh bagi rekan sebaya.</p>
            </div>
        </div>
        <div class="action-buttons">
            <a href="kandidat.php" class="action-btn">KEMBALI</a>
            <a href="konfirmasi.php?id=1" class="action-btn">PILIH</a>
        </div>
    </div>
</div>
</body>
